...
R1.optimise(method=orca, keywords=ade.OptKeywords(['Opt', 'PBEPBE', 'def2-SVP', 'def2-SVP/C', 'def2/J', 'RIJCOSX', 'D3BJ']), n_cores=Cores)
P1.optimise(method=orca, keywords=ade.OptKeywords(['Opt', 'PBEPBE', 'def2-SVP', 'def2-SVP/C', 'def2/J', 'RIJCOSX', 'D3BJ']),n_cores=Cores)
